...
#include <sys/types.h>
#include <time.h>
#include <unistd.h>            // assume defined(__unix__)

#include "sse_helper.h"

#define SSE_SERVER_PORT   8080
#define SSE_INTERVAL_SECS 1
...
//  dispatch_queue_t 
    ...
    /*    defined sse_helper.h, initialised line 19 
    ...
    server_addr.sin_port        = htons(SSE_SERVER_PORT);
